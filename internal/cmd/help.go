...
func ShowHelp() {
	...
	fmt.Println("  jenvy init                               # Initialize JVM environment variables")
	fmt.Println("")
	...
	fmt.Println("  jenvy dl 17 && jvm ex downloaded-archive.zip")
	...
	fmt.Println("  jenvy dl 17                              # Then use: jvm <Tab> to see commands")
}
