...
func ShowHelp() {
	...
	fmt.Println("──────────────────")
	fmt.Println("  jvm extract (ex)                       # List available archives to extract")
	fmt.Println("  jvm extract 17                          # Extract any JDK 17.x.y version")
	fmt.Println("  jvm extract 21                          # Extract any JDK 21.x.y version")
	fmt.Println("  jvm extract JDK-17.0.16+8              # Extract specific JDK version")
	fmt.Println("")
	...
	fmt.Println("  jvm remove (rm) <version>              # Remove installed JDK version")
	fmt.Println("  jvm remove (rm) --all                  # Remove ALL JDK installations")
	fmt.Println("")
	...
	fmt.Println("  jvm dl 17 && jvm ex downloaded-archive.zip")
	fmt.Println("  jvm extract adoptium-jdk-21.zip")
